...
3. Sua URI do S3 deve ser algo assim: https://bucket-name.s3.ap-south-1.amazonaws.com/sketch-name.ino.bin
4. Copie a URI dispare-a no seu navegador ou faça o curl `curl -I -v https://bucket-name.ap-south-1.amazonaws.com/sketch-name.ino.bin` para validar o mesmo
